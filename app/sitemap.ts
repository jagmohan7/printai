...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/products/chatbots`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/products/automation`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
  ];
}
