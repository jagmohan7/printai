    ...
    defineField({ name: "seo", title: "SEO", type: "object", group: "seo",
      fields: [
        ...
        defineField({ name: "canonicalUrl", title: "Canonical URL", type: "string",
          description: "Override the canonical URL for this page. Leave blank to use the default (/blog). E.g. https://printai.cloud/blog",
          placeholder: "https://printai.cloud/blog" }),
