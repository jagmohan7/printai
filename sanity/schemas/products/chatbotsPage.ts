  ...
  fields: [
    ...
    defineField({ name: "hero", title: "Hero Section", type: "object", group: "hero",
      ...
      fields: [
        ...
        defineField({ name: "chatMessages", title: "Chat Preview Messages", type: "array",
          description: "4 message pairs displayed in the animated chat preview.",
          of: [defineArrayMember({ type: "object", name: "msg", preview: { select: { title: "userText", subtitle: "botText" } },
            fields: [
              defineField({ name: "userText", title: "User says",   type: "string" }),
              defineField({ name: "botText",  title: "Bot replies", type: "text", rows: 2 }),
            ],
          })],
        }),
      ],
    ...
    defineField({ name: "demo", title: "Demo Section", type: "object", group: "demo",
      ...
      fields: [
        ...
        defineField({ name: "demoMessages", title: "Demo Chat Messages", type: "array",
          of: [defineArrayMember({ type: "object", name: "msg", preview: { select: { title: "userText", subtitle: "botText" } },
            fields: [
              defineField({ name: "userText", title: "User",  type: "string" }),
              defineField({ name: "botText",  title: "Bot",   type: "text", rows: 3 }),
            ],
          })],
        }),
        defineField({ name: "quickReplyButtons", title: "Quick Reply Buttons", type: "array",
          description: "3 suggested-reply buttons under the chat.",
          of: [{ type: "string" }],
        }),
      ],
    }),
    ...
    defineField({ name: "finalCta", title: "Final CTA Section", type: "object", group: "finalCta",
      description: "Bottom-of-page CTA banner with social proof points.",
      fields: [
