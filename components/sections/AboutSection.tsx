    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              {highlights.map((label, i) => (
                <MotionInView
                  key={label}
                  delay={i * 0.15}
                  className="flex items-start gap-3 p-3.5 rounded-xl bg-[#12131f] border border-white/[0.06] hover:border-emerald-500/30 hover:bg-[#161728] transition-all duration-300"
                >
          ...
          {/* Brain orbit visual */}
          <MotionInView delay={0.15} className="relative">
