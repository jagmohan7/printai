...
export default function HeroSection() {
  return (
    ...
    >
      <div className="pointer-events-none absolute left-[-8%] top-[20%] w-[550px] h-[550px] rounded-full bg-[#5b21b6]/25 blur-[130px] anim-float" />
      <div className="pointer-events-none absolute right-[-4%] top-[30%] w-[420px] h-[420px] rounded-full bg-[#0f766e]/20 blur-[120px] anim-float delay-300" />
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full max-w-[800px] mx-auto">
        <div className="mb-8 inline-flex items-center gap-2 px-4 py-[9px] rounded-full border border-white/10 bg-white/[0.05] backdrop-blur-sm anim-fade-up">
        ...
        <h1 className="font-extrabold text-white leading-[1.12] tracking-tight mb-6 text-[2.6rem] sm:text-[3.2rem] lg:text-[3.75rem] anim-fade-up delay-100">
          Transform Your{" "}
        ...
        <p className="text-gray-400 text-[16.5px] sm:text-[17.5px] leading-[1.8] max-w-[580px] mb-10 anim-fade-up delay-200">
        ...
        <div className="flex items-center gap-4 mb-12 flex-wrap justify-center anim-fade-up delay-300">
          <Link
            href="/#contact"
        ...
        <div className="flex items-center gap-3 anim-fade-up delay-400">
