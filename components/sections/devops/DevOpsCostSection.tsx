        ...
        <div className="space-y-3">
          {costs.map((item, i) => (
            <MotionInView key={i} delay={0.1 + i * 0.1}>
              <div className={`group flex items-center gap-4 px-7 py-5 rounded-2xl border transition-all duration-300 ${i === accentIdx ? "border-red-500/50 bg-[#12131f] shadow-[0_0_24px_rgba(239,68,68,0.12)]" : "border-white/[0.06] bg-[#12131f] hover:border-red-400/30 hover:shadow-[0_4px_24px_rgba(239,68,68,0.08)]"}`}>
