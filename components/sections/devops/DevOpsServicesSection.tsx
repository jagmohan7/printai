          ...
          {services.map((s, i) => {
            ...
            return (
              <MotionInView key={i} delay={0.09 * i}>
                <div className="group h-full p-7 rounded-2xl border transition-all duration-300 border-[var(--pa-line)] bg-[var(--pa-card)] hover:border-[#06b6d4]/35 hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(6,182,212,0.2)]">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300 bg-[var(--pa-card)] border border-[var(--pa-line)] group-hover:bg-cyan-500/10 group-hover:border-cyan-400/20">
