    ...
    <section className="relative overflow-hidden bg-[#0B1220] section-pad px-4 border-t border-[#1E293B]/50">
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <MotionInView>
            <div className="h-full rounded-2xl border border-[#1E293B] bg-[#0F172A] p-8 sm:p-10">
              ...
              <ul className="space-y-4">
                {beforeItems.map((item, i) => (
                  <MotionInView key={i} delay={0.1 + i * 0.08} className="flex items-center gap-3.5 text-gray-300 text-[15px]">
            ...
            <div className="h-full rounded-2xl border border-[#1E293B] bg-[#0F172A] p-8 sm:p-10">
              ...
              <ul className="space-y-4">
                {afterItems.map((item, i) => (
                  <MotionInView key={i} delay={0.25 + i * 0.08} className="flex items-center gap-3.5 text-gray-300 text-[15px]">
