        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {items.map((item, i) => (
            <MotionInView key={i} delay={0.09 * i}>
              <div className="pa-card pa-card-hover group flex items-center gap-4 px-6 py-5 rounded-2xl border border-[var(--pa-line)] bg-[var(--pa-card)] hover:border-[#06b6d4]/40 hover:-translate-y-0.5 hover:shadow-[0_6px_28px_rgba(6,182,212,0.12)] transition-all duration-300">
