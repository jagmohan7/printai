...
export default function CustomAIComparisonSection({ data }: Props) {
  ...
  return (
    <section className="relative overflow-hidden ai-section section-pad px-4 border-t border-white/[0.04]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <MotionInView>
            <div className="ai-card h-full rounded-2xl border border-white/[0.07] bg-[#12131f] p-8">
              <div className="flex items-center gap-3 mb-7">
                ...
                <h3 className="text-white font-extrabold text-[1.25rem]">Generic AI Tools</h3>
              </div>
              <div className="space-y-4">
                {rows.map((r, i) => (
                  <div key={i} className="flex items-start gap-3 pb-4 border-b border-white/[0.05] last:border-0 last:pb-0">
                    ...
                    <div>
                      <p className="text-[#6b7280] text-[11px] font-semibold uppercase tracking-wider mb-0.5">{r.aspect}</p>
                      <p className="text-[#d1d5db] text-[14.5px] font-medium">{r.generic}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <MotionInView delay={0.15}>
            <div className="ai-card h-full rounded-2xl border border-[#06b6d4]/40 bg-gradient-to-br from-[#0d0e1f] to-[#0a0b18] shadow-[0_0_50px_rgba(6,182,212,0.14)] p-8">
              <div className="flex items-center gap-3 mb-7">
                ...
                {rows.map((r, i) => (
                  <div key={i} className="flex items-start gap-3 pb-4 border-b border-white/[0.05] last:border-0 last:pb-0">
                    ...
                    <div>
                      ...
                      <p className="text-white text-[14.5px] font-bold">{r.custom}</p>
                    </div>
                  </div>
                ))}
              </div>
